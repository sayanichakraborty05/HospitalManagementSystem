...
@WebServlet("/RecentPatientsServlet")
public class RecentPatientsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql = "SELECT full_name, created_at FROM patients ORDER BY created_at DESC LIMIT 10";
